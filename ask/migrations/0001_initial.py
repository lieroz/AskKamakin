# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-12-19 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_image', models.ImageField(upload_to=b'avatars/%Y/%m/%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_like_answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ask.Question')),
                ('question_like_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
